...
// reached UDC's live page before anyone noticed. Esri's Canvas basemaps serve
// dark and light variants with no key, and their attribution requirement is met
// below.
const TILE_LAYERS = {
  dark: {
