  ...
  return (
    <div className={className}>
            ...
            <button
              ...
              className={`text-left p-4 rounded-xl border transition-all duration-200 ${
                isSelected
                  ...
                  : isDark
                    ? "border-panel-border bg-panel-bg/60 hover:bg-panel-hover hover:border-slate-600"
      ...
      {spikeSummary && selectedId && (
        ...
        >
          <h4 className={`text-xs font-semibold mb-3 flex items-center gap-2 ${isDark ? "text-white" : "text-slate-900"}`}>
            <Activity className="w-3.5 h-3.5" />
            Spike Detection Summary
          </h4>
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
            <div>
              <p className={`text-[10px] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Total Spikes</p>
            ...
            <div>
              <p className={`text-[10px] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Peak Hour</p>
              <p className={`text-lg font-bold ${isDark ? "text-white" : "text-slate-900"}`}>
            ...
            <div>
              <p className={`text-[10px] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Most Affected</p>
              <p className={`text-xs font-semibold truncate ${isDark ? "text-white" : "text-slate-900"}`}>
                {spikeSummary.mostAffectedStation}
              </p>
            </div>
            <div>
              <p className={`text-[10px] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Parameters</p>
