            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div key={src.badge} className={`glass-panel rounded-xl p-4 border ${isDark ? "" : ""}`}>
                  ...
                  <p className={`text-xs mb-3 leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}>{src.description}</p>
                  <div className={`space-y-1 text-[10px] ${isDark ? "text-slate-500" : "text-slate-500"}`}>
                ...
                <div key={param.field} className="glass-panel rounded-xl p-5">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      ...
                      <code className={`text-[10px] ${isDark ? "text-slate-500" : "text-slate-400"}`}>field: {param.field}</code>
                    </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {[
                      ...
                      <div key={detail.label}>
                        <div className={`text-[10px] font-medium uppercase ${isDark ? "text-slate-500" : "text-slate-400"}`}>{detail.label}</div>
                ...
                <thead>
                  <tr className={`border-b ${isDark ? "border-panel-border bg-udc-dark/30" : "border-slate-200 bg-slate-50"}`}>
                    {["Parameter", "Min", "Max", "Unit", "Action if Out-of-Range"].map((h) => (
                      <th key={h} className={`text-left py-2 px-4 text-xs font-medium uppercase ${isDark ? "text-slate-500" : "text-slate-400"}`}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {DATA_DICTIONARY.map((p) => {
                    ...
                    return (
                      <tr key={p.field} className={`border-b ${isDark ? "border-panel-border/50" : "border-slate-100"}`}>
                        ...
                        <td className={`py-2 px-4 text-xs ${isDark ? "text-slate-400" : "text-slate-600"}`}>{min}</td>
                        <td className={`py-2 px-4 text-xs ${isDark ? "text-slate-400" : "text-slate-600"}`}>{max}</td>
                        <td className={`py-2 px-4 text-xs ${isDark ? "text-slate-400" : "text-slate-600"}`}>{p.unit}</td>
                  ...
                  <tbody>
                    {logs.map((log) => (
                      <tr key={log.id} className={`border-b ${isDark ? "border-panel-border/50" : "border-slate-100"}`}>
                        ...
                        <td className={`py-2 px-4 text-xs ${isDark ? "text-slate-400" : "text-slate-600"}`}>
                          {log.records_count.toLocaleString()}
                        </td>
                        <td className={`py-2 px-4 text-xs max-w-xs truncate ${log.error_message ? "text-red-400" : isDark ? "text-slate-600" : "text-slate-400"}`}>
                          {log.error_message || "—"}
                        </td>
                      </tr>
                    ))}
